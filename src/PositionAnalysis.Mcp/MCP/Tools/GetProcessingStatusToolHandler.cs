...
public class GetProcessingStatusToolHandler : IMcpToolHandler
{
    ...
    public string Description => "Get processing progress for ALL occupational series with no filtering. Do NOT use this if the user names specific series, org codes, or PD numbers ΓÇö use get_processing_status_by_series, get_processing_status_by_orgs, or get_processing_status_by_pd instead.";
