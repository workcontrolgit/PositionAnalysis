...
public class ExportOrchestratorTests
{
    ...
    public async Task ExportAllAsync_CreatesReferenceHrTrackerWorkbook()
    {
        ...
        try
        {
            ...
            var workbookPath = Path.Combine(reportsDirectory, "tracker-excel", "SchedulePC-Eval-Tracker-2026-08-10.xlsx");
    ...
    private sealed class EvaluationRepository(EvaluationResult result) : ISchedulePCEvalRepository
    {
